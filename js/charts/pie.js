...
function pie() {
     ...
     */
    var _pie = d3.pie().sort(null);

    var _arc = d3.arc().innerRadius(0);
        ...
        return function (d, i) {
            if (tooltip) {
                UTIL.updateTooltip.call(
                    ...
                    _buildTooltipData(d.data, me),
                    container,
                    COMMON.COLORSCALE(d.data[_dimension[0]]),
                    _notification
                );
            }
        };
    ...
    function chart(selection) {
        ...
        _localSortedMeasureValue = _data.map(function (d) {
            return +d[_measure[0]];
        });
    ...
    chart.update = function (data) {
        ...
        pieMask = svg.selectAll("g.arc-mask").data(_pie(data), _localKey);
        ...
        pieArcGroup = svg.selectAll("g.arc").data(_pie(data), _localKey);
