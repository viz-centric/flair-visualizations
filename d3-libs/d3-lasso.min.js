    ...
    function lasso() {
        ...
        function lasso(_this) {
            ...
            function dragmove() {
                ...
                var x,y;
                if(_d3.event.sourceEvent.type === "touchmove") {
                    x = _d3.event.sourceEvent.touches[0].clientX;
                    y = _d3.event.sourceEvent.touches[0].clientY;
                }
                else {
                    x = _d3.event.sourceEvent.clientX;
                    y = _d3.event.sourceEvent.clientY;
                }
                

                // Get mouse position within drawing area, used for rendering
                var tx = _d3.mouse(this)[0];
                var ty = _d3.mouse(this)[1];
